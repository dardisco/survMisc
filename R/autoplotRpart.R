...
##' \cr Needs to be in range \eqn{0-1}.  A value of 1 gives square
##' shouldered branches,
##' a value of 0 gives V shaped branches, with other values being intermediate.
...
##'                leafSize=10, , yLD=0.08, nodeLabels=seq(13))$plot
